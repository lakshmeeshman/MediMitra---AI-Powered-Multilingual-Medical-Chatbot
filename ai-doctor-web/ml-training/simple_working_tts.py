#!/usr/bin/env python3
"""
Simple Working TTS Service for Regional Language Pronunciation
Uses a reliable approach for Hindi and Marathi TTS
"""
...
def load_models():
    ...
    try:
        ...
        # Load a simple, reliable TTS model
        print("🔄 Loading simple TTS pipeline...")
        try:
            # Use a simple model that works reliably
...
def generate_speech(text, language, gender):
    ...
    try:
        # For Hindi and Marathi, we'll use a transliteration approach
        if language in ["hi", "mr"]:
            # Convert Hindi/Marathi to English transliteration for TTS
            # This is a simple approach that will work with any TTS model
...
def transliterate_to_english(text):
    """Simple transliteration from Hindi/Devanagari to English"""
...
if __name__ == "__main__":
    print("🚀 Starting Simple Working TTS Service...")
